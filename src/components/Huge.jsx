  ...
  getColumns = () => {
    return [
      ...
      },
      {
        ...
        dataIndex: 'wasteList',
        key: 'inPrice',
        render: (wasteList) => (<div>{wasteList[0].inPrice}</div>)
      },
      {
        title: '车数',
        dataIndex: 'wasteList',
      ...
      },
      {
        ...
        dataIndex: 'wasteList',
        key: 'outPrice',
        render: (wasteList) => (<div>{wasteList[0].outPrice}</div>)
      },
      {
        title: '车数',
        dataIndex: 'wasteList',
